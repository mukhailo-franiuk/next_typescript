let getInputs = selector => document.querySelector(selector) as HTMLInputElement;

let getButtons = selector => document.querySelector(selector) as HTMLInputElement;

getInputs('#login').addEventListener('input', function (): void {
...
getInputs('#pass').addEventListener('input', function (): void {
...
getInputs('#email').addEventListener('input', function (): void {
